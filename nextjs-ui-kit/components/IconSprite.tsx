/**
 * Renders once near the top of the tree. Every icon elsewhere is
 * <svg className="ico"><use href="#i-dashboard" /></svg> and pulls from here.
 * Add more <symbol>s as needed — keep the id prefix `i-`.
 */
export function IconSprite() {
  return (
    <svg width="0" height="0" style={{ position: "absolute" }} aria-hidden="true">
      ...
      <symbol id="i-percent" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
